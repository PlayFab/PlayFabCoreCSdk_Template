%BUILD_SOURCESDIRECTORY%\Utilities\Pipelines\Scripts\ReadSDKVerHeader.exe %BUILD_SOURCESDIRECTORY%\code\source\build_version.h year > year.txt
%BUILD_SOURCESDIRECTORY%\Utilities\Pipelines\Scripts\ReadSDKVerHeader.exe %BUILD_SOURCESDIRECTORY%\code\source\build_version.h month > month.txt
%BUILD_SOURCESDIRECTORY%\Utilities\Pipelines\Scripts\ReadSDKVerHeader.exe %BUILD_SOURCESDIRECTORY%\code\source\build_version.h qfe > qfe.txt
