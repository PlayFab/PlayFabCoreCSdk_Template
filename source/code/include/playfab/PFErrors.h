...
#define E_PF_RATELIMITEXCEEDED                     MAKE_E_HC(0x5403L) // 0x89235403
#define E_PF_OVERGAMEMANAGERLIMIT                  MAKE_E_HC(0x5404L) // 0x89235404
#define E_PF_SERVICEUNAVAILABLE                    MAKE_E_HC(0x5405L) // 0x89235405
